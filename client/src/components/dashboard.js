		...
		return (
			<div>
				...
				<BootstrapTable ref='table' data={ this.props.content } pagination={ true } options={ this.options } selectRow={ selectRowProp } striped hover condensed>
					...
					<TableHeaderColumn dataField='fg' width='40' dataSort={ true } hidden>FG</TableHeaderColumn>
					<TableHeaderColumn dataField='ft' width='40' dataSort={ true } hidden>FT</TableHeaderColumn>
